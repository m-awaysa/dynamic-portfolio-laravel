...
<div class="container">
  <!--  button add skill  -->
  <form action="{{route('skill.add')}}" method="get">
      @csrf
        ...
        @if ($skills->count())
            ...
            @foreach($skills as $skill)
                <tr>
                    ...
                    <td><?php if($skill->visibility) {echo "true";}  else   echo "false"   ?></td>
                    <td>
                    ...
                    <td>  
                        ...
                        <a  class="btn btn-danger"
                            href="#" onclick="confirmDelete( '<?php echo route('skill.delete',$skill) ?>' )"  >
